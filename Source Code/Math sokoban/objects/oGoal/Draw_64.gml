...
if valeur2 == true{
	draw_text_transformed(posC1,0.1*room_height,";",1.5,1.5,0)
	draw_set_color(col2)
	draw_text_transformed(pos2,0.1*room_height,string(valeur2draw),1.5,1.5,0)
}

if valeur3 == true{
	draw_text_transformed(posC2,0.1*room_height,";",1.5,1.5,0)
	draw_set_color(col3)
	draw_text_transformed(pos3,0.1*room_height,string(valeur3draw),1.5,1.5,0)
}

if valeur4 == true{
	draw_text_transformed(posC3,0.1*room_height,";",1.5,1.5,0)
	draw_set_color(col4)
	draw_text_transformed(pos4,0.1*room_height,string(valeur4draw),1.5,1.5,0)
}
