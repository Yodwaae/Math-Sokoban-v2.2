...
if (oPlayer.movementCounter <= oGoal.limit) and (oGoal.alreadyUsed = true) { // objectif atteint en fin de level
	...
	//draw_text(0.5*room_width-1,0.63*room_height,"Current Moves Counter : " + string(oPlayer.movementCounter));
	//draw_text(0.5*room_width-1,0.78*room_height,"Star Limit : " + string(oGoal.limit));
	...
	//draw_text(0.5*room_width,0.63*room_height-1,"Current Moves Counter : " + string(oPlayer.movementCounter));
	//draw_text(0.5*room_width,0.78*room_height-1,"Star Limit : " + string(oGoal.limit));
	//draw_text(0.5*room_width+1,0.63*room_height,"Current Moves Counter : " + string(oPlayer.movementCounter));
	//draw_text(0.5*room_width+1,0.78*room_height,"Star Limit : " + string(oGoal.limit));
